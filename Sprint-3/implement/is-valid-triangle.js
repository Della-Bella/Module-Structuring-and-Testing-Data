...
//console.log(isValidTriangle(1, 6, 5));
...
// first i put && and it gave undefined, so I used | | which checks checks if at least
    // one condition is true.It returns true if any of the conditions is true.
    //It only returns false if all conditions are false.false, 0, null, undefined, NaN,

// Example usage
//console.log(isValidTriangle(1, 6, 5)); // Outputit is not valid triangle
//console.log(isValidTriangle(1, 0, 3)); // Output: it is not valid triangle
...
//we need to invalidate any triangle where the sum of any two sides is less than or equal to
//the length of the third side.
// and we need to validate any triangle where the sum of any two sides is greater than the
